...
You will find a db.sql file in the parent folder it contains dummy datas. Be sure to insert the data in the PostgreSQL DB, so that data can be fetched by the backend server. Make sure to insert the data after running the app, As Tables will automatically created in the DB.
